@extends('layout')
@section('titre', 'Electronique numérique')
@section('contenu')
...
<div class="info_list">
   ...
   <div class="border-box">
     ...
     <br><header>
            <div class="title">Electronique numérique</div>
            <div class="timer">
...
<div class="option">
    ...
    <script src="{{asset('js/electro/file.js')}}"></script>
    <script src="{{asset('js/electro/file12.js')}}"></script>
