...
next_btn.onclick = ()=>{
    ...
    let que_tag ='<span>'+questions[file].numb +"."+ questions[file].question +'</span>'
     let option_tag ='<div class="option">'+ questions[file].option[0] +'<span></span></div>'
                    +'<div class="option"> '+ questions[file].option[1] +'<span></span></div>'
                    +'<div class="option">'+ questions[file].option[2]+'<span></span></div>'
                    +'<div class="option">'+ questions[file].option[3] +'<span></span></div>';
...
function showResultBox(){
     ...
     border_box.classList.remove("activeborder");//hide the info box
      ...
      if(userScore > 6){
          let scoretag ='<span style="margin-left:76px">Félicitation, vous avez  <p style="color:#FD8C04;">'+ userScore  +'</p> parmi  <p style="color:#FD8C04;">'+ questions.length+'.</p></span>';
         scoreText.innerHTML = scoretag;
    }
         else if(userScore > 1){
          let scoretag ='<span style="margin-left:76px">Bien, vous avez  <p style="color:#FD8C04;">'+ userScore  +'</p> parmi   <p style="color:#FD8C04;">'+ questions.length+'.</p></span>';
         scoreText.innerHTML = scoretag;
    }
    else{
          let scoretag ='<span style="margin-left:76px">Désole, vous avez sauf <p style="color:#FD8C04;">'+ userScore  +'</p> parmi   <p style="color:#FD8C04;">'+ questions.length+'.</p></span>';
         scoreText.innerHTML = scoretag;
          }
}
...
let totalQuesCountTag ='<span><p>' + file +'</p>in<p>'+ questions.length+'</p>quistions</span>';
